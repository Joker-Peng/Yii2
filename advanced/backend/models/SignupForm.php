...
class SignupForm extends Model
{
    ...
    public function rules()
    {
        return [
            ...
            ['username', 'unique', 'targetClass' => '\backend\models\UserBackendForm', 'message' => '用户名已存在.'],
            ...
            ['email', 'unique', 'targetClass' => '\backend\models\UserBackendForm', 'message' => 'email已经被设置了.'],
     ...
     * Date: 2019/12/31
     * Time: 15:06
     * @return bool|null true|false 添加成功或者添加失败
    ...
    public function signup()
    {
        ...
        // save(false)的意思是：不调用 UserBackendForm 的rules再做校验并实现数据入库操作
        // 这里这个false如果不加，save底层会调用 UserBackendForm 的rules方法再对数据进行一次校验，这是没有必要的。
        // 因为我们上面已经调用Signup的rules校验过了，这里就没必要再用 UserBackendForm 的rules校验了
